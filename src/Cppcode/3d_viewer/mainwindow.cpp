...
MainWindow::MainWindow(QWidget *parent)
  ...
  connect(ui->set_vert_color_button, SIGNAL(clicked()), this,
          SLOT(on_color_vert_button_clicked()));
  connect(ui->set_edge_color_button, SIGNAL(clicked()), this,
          SLOT(on_color_lines_button_clicked()));
  connect(ui->set_color_button, SIGNAL(clicked()), this,
          SLOT(on_color_back_button_clicked()));
}
...
// color buttons
void MainWindow::on_color_vert_button_clicked() {
  QColor colour = QColorDialog::getColor(Qt::white, this, "Select color:");
  ui->view->color_vert = colour;
  ui->view->update();
}

void MainWindow::on_color_lines_button_clicked() {
  QColor colour = QColorDialog::getColor(Qt::white, this, "Select color:");
  ui->view->color_lines = colour;
  ui->view->update();
}

void MainWindow::on_color_back_button_clicked() {
  QColor colour = QColorDialog::getColor(Qt::white, this, "Select color:");
